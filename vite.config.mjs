...
export default defineConfig(({ mode }) => {
  ...
  const driveUrl = env.GAS_DRIVE_UPLOAD_URL || 'https://script.google.com/macros/s/AKfycbx92MRn6l-A3GDn3QcXL5W_lhf1WXuk972kDdxQXrfNrmIqOq07F_aiLoYFQ6oQsBNzGA/exec';
